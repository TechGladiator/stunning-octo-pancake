let { errorCount, editable, mapped, fieldData, fieldNames, fieldErrors, firstError, end, start, rowCount, code, message, fileName, headerCheck, name, row, fullResults, pageSwitch, firstRun, fieldState, fieldZip, fieldDate, markers, geocoder, infowindow, map, lat, long } = require("./globalLets");

const { names, wrapper2, wrapper1, mainTitle, wrapper3 } = require("./globalConsts");
